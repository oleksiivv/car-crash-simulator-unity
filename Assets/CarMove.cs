...
public class CarMove : MonoBehaviour
{
    ...
    public void Init(Slider _moveSlider, GameObject _handler){
        ...
        runFX = transform.GetChild(transform.childCount - 1).gameObject.GetComponent<ParticleSystem>();
    }
    ...
    void Update(){
        ...
        if(isMoving){
            if(acceleration<2)acceleration+=0.125f*speedCoef;
